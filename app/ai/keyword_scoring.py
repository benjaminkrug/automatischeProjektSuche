...
# Mindestens 200 für sicheren Reject (Threshold = 100)
REJECT_KEYWORDS_WEIGHTED: Dict[str, int] = {
    ...
    "lüftungsanlage": 200,
    "klimaanlage": 200,
    "sanitärinstallation": 200,
    "kältetechnik": 200,
    # Facility/Reinigung
    "gebäudereinigung": 200,
    "unterhaltsreinigung": 200,
    "winterdienst": 200,
    "grünflächenpflege": 200,
    # Sicherheit (physisch)
    "wachdienst": 200,
    "objektschutz": 200,
    "sicherheitsdienst": 200,
    "pförtnerdienst": 200,
    # Druck/Büro
    "druckerzeugnisse": 200,
    "drucksachen": 200,
    "büromöbel": 200,
    "arbeitskleidung": 200,
}
